...
/**
 * Convenience access to all tables in fishing_reservation
 */
@Generated(
    value = {
        "http://www.jooq.org",
...
public class Tables {
     ...
     */
    public static final Account ACCOUNT = com.ddastudio.fishing.jooq.tables.Account.ACCOUNT;
 ...
 - 선단별로 앱을 각각 가짐
     ...
     */
    public static final AppMaster APP_MASTER = com.ddastudio.fishing.jooq.tables.AppMaster.APP_MASTER;

    /**
     * The table <code>fishing_reservation.bank_master</code>.
     */
    public static final BankMaster BANK_MASTER = com.ddastudio.fishing.jooq.tables.BankMaster.BANK_MASTER;
 ...
 - type, captain_id, capacity, fish_type, from_time, to_time의 값들은 일정(schedule) 등록시 기본팅값으로 사용
   ( schedule 테이블에도 똑같은 컬럼이 존재 )
     */
    public static final BoatMaster BOAT_MASTER = com.ddastudio.fishing.jooq.tables.BoatMaster.BOAT_MASTER;

    /**
     * The table <code>fishing_reservation.code_master</code>.
     */
    public static final CodeMaster CODE_MASTER = com.ddastudio.fishing.jooq.tables.CodeMaster.CODE_MASTER;
 ...
 - 현재 사용안함
     ...
     */
    public static final CommunityComment COMMUNITY_COMMENT = com.ddastudio.fishing.jooq.tables.CommunityComment.COMMUNITY_COMMENT;

    /**
     * 커뮤니티 게시글
 - 현재 사용안함
     */
    public static final CommunityContent COMMUNITY_CONTENT = com.ddastudio.fishing.jooq.tables.CommunityContent.COMMUNITY_CONTENT;
 ...
 - 현재 사용 안함
     ...
     */
    public static final MyNews MY_NEWS = com.ddastudio.fishing.jooq.tables.MyNews.MY_NEWS;

    /**
     * The table <code>fishing_reservation.oauth_client_details</code>.
     */
    public static final OauthClientDetails OAUTH_CLIENT_DETAILS = com.ddastudio.fishing.jooq.tables.OauthClientDetails.OAUTH_CLIENT_DETAILS;

    /**
     * 예약 관리
     */
    public static final Reservation RESERVATION = com.ddastudio.fishing.jooq.tables.Reservation.RESERVATION;

    /**
     * The table <code>fishing_reservation.reservation_history</code>.
     */
    public static final ReservationHistory RESERVATION_HISTORY = com.ddastudio.fishing.jooq.tables.ReservationHistory.RESERVATION_HISTORY;

    /**
     * 예약대기 관리
     */
    public static final ReservationWaiting RESERVATION_WAITING = com.ddastudio.fishing.jooq.tables.ReservationWaiting.RESERVATION_WAITING;
 ...
 - 일정 등록화면에서 배를 선택하게 되면 boat_master 테이블에 저장된 값을 기본값으로 from_time, to_time, fish_type, capacity, price, captain_id 값을 세팅해줌
     */
    public static final Schedule SCHEDULE = com.ddastudio.fishing.jooq.tables.Schedule.SCHEDULE;

    /**
     * The table <code>fishing_reservation.test_master</code>.
     */
    public static final TestMaster TEST_MASTER = com.ddastudio.fishing.jooq.tables.TestMaster.TEST_MASTER;

    /**
     * The table <code>fishing_reservation.used_refresh_token</code>.
     */
    public static final UsedRefreshToken USED_REFRESH_TOKEN = com.ddastudio.fishing.jooq.tables.UsedRefreshToken.USED_REFRESH_TOKEN;

    /**
     * 사용자 관리
     */
    public static final User USER = com.ddastudio.fishing.jooq.tables.User.USER;
}
